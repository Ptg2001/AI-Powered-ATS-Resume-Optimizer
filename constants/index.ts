...
1. READ THE RESUME TEXT CAREFULLY - analyze every section thoroughly
2. Look for specific skills, experiences, and achievements mentioned
3. Compare against the job description requirements
4. Provide specific, actionable feedback based on actual content
5. If the resume has good content but poor formatting, explain both aspects
6. Give realistic scores based on actual resume quality, not generic responses
